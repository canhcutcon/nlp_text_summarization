...
5. **Pretrained models hạn chế**:
   - PhoBERT, mT5 trained trên corpus nhỏ hơn
   - ViT5 mới, chưa được optimize nhiều

### Q3: Sự khác biệt giữa PhoBERT, mT5 và ViT5?

**A:**

| Feature           | PhoBERT               | mT5                  | ViT5                       |
| ----------------- | --------------------- | -------------------- | -------------------------- |
| **Architecture**  | BERT (encoder-only)   | T5 (encoder-decoder) | T5 (encoder-decoder)       |
| **Pre-training**  | Masked Language Model | Span corruption      | Span corruption            |
| **Language**      | Vietnamese only       | 101 languages        | Vietnamese only            |
| **Best for**      | Classification, NER   | Translation, Summary | Vietnamese tasks           |
| **Parameters**    | 135M (base)           | 580M (base)          | 250M                       |
| **Training data** | 20GB Vietnamese       | mC4 (multilingual)   | 40GB Vietnamese            |
| **Your results**  | Lower ROUGE           | Medium ROUGE         | **Highest ROUGE-1: 0.448** |

**Tại sao ViT5 tốt nhất trong project của bạn:**

- Được train riêng cho tiếng Việt
- Encoder-decoder architecture phù hợp cho summarization
- Hiểu context tiếng Việt tốt hơn mT5 (multilingual)
- PhoBERT không có decoder nên không phù hợp cho abstractive
...
| BARTpho            | VLSP 2021 | 0.432     | 0.189     | 0.371     |
| mT5-base           | VLSP 2021 | 0.398     | 0.165     | 0.342     |
| PhoBERT-extractive | VLSP 2021 | 0.385     | 0.152     | 0.328     |
| Lead-3 baseline    | VLSP 2021 | 0.321     | 0.112     | 0.287     |

**State-of-the-art for Vietnamese:**

- Best published: BARTpho với ROUGE-1 ~0.45
- Your result: **Comparable to SOTA**
- Có thể cải thiện lên ~0.47 với hyperparameter tuning
...
✅ Trên baseline và mT5 significantly
✅ Ready for publication nếu có thorough analysis
